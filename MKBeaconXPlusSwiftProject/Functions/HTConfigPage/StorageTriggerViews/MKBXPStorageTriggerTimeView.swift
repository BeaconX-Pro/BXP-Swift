//
//  MKBXPStorageTriggerTimeView.swift
...
/// 时间触发条件配置视图
public final class MKBXPStorageTriggerTimeView: UIView {
    ...
    public func updateTime(_ time: String) {
        ...
        valueButton.setTitle(time, for: .normal)
    ...
    private func processSelectMethod(_ index: Int) {
        noteLabel.text = "*The device stores T&H data every \(dataList[index]) minutes."
        setNeedsLayout()
    }
